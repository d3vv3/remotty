  ...
  return (
    <main className="public-page privacy-page">
      ...
      <section className="privacy-masthead">
        <p className="public-kicker"><LockKeyhole aria-hidden="true" /> Private by design</p>
        <h1>Your work.<br /><em>Your devices.</em></h1>
      ...
      <section className="public-band" aria-labelledby="encryption-title">
        <div className="public-section-heading"><p className="public-kicker">How it works</p><h2 id="encryption-title">Encryption starts before the network.</h2></div>
      ...
      <section className="public-band privacy-ledger" aria-labelledby="handling-title">
        <div className="public-section-heading"><p className="public-kicker">Data handling</p><h2 id="handling-title">What is stored and seen.</h2></div>
      ...
      <section className="security-boundary" aria-labelledby="boundary-title">
        <div><p className="public-kicker"><ShieldAlert aria-hidden="true" /> Security boundary</p><h2 id="boundary-title">What encryption does not hide.</h2></div>
