...
// clock invalidates the memo for relative timestamps; Markdown has its own memo.
export const ActivityMessages = memo(function ActivityMessages({ presentation, showToolCalls = true }: { presentation: ReturnType<typeof activityPresentation>; showToolCalls?: boolean; clock?: number }) {
