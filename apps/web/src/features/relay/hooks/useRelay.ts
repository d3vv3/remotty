      ...
      socket.addEventListener("message", (message) => {
        ...
        if (control.success) {
          if (control.data.type === "broker.challenge" && !helloStarted) {
            ...
            else setError("No OpenCode workspace is connected. On your computer run `opencode plugin add opencode-remotty`, quit OpenCode, then run `opencode --continue` and keep this page open. Pairing resumes automatically.")
